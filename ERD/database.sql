...
CREATE TABLE CHI_TIET_DON_HANG (
    ...
    MaSP VARCHAR(30) NOT NULL,
    SoLuong INT NOT NULL,
    CONSTRAINT pk_ctdh PRIMARY KEY (MaGH, MaSP),
	CONSTRAINT fk_ctdh_magh FOREIGN KEY (MaGH) REFERENCES GIO_HANG(MaGH),
    CONSTRAINT fk_ctdh_masp FOREIGN KEY (MaSP) REFERENCES SAN_PHAM(MaSP)
);

CREATE TABLE WISHLIST (
    MaWL VARCHAR(30) NOT NULL PRIMARY KEY,
    MaKH VARCHAR(30) NOT NULL,
	CONSTRAINT fk_wishlist_makh FOREIGN KEY (MaKH) REFERENCES KHACH_HANG(MaKH)
);

CREATE TABLE CHI_TIET_WISHLIST (
    MaWL VARCHAR(30) NOT NULL,
    MaSP VARCHAR(30) NOT NULL,
    CONSTRAINT pk_wishlist PRIMARY KEY (MaWL, MaSP),
	CONSTRAINT fk_wishlist_magh FOREIGN KEY (MaWL) REFERENCES WISHLIST(MaWL),
    CONSTRAINT fk_wishlist_masp FOREIGN KEY (MaSP) REFERENCES SAN_PHAM(MaSP)
);
